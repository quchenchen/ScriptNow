...
from scriptflow_v7.script.export import ScriptExportScene, render_script_docx
...
class ScriptExportService:
    def __init__(
        self, database: Database, renderer: Callable[..., bytes] = render_script_docx
    ) -> None:
    ...
    async def options(self, *, tenant_id: str, project_id: str) -> dict[str, object]:
        async with self.database.session() as session:
            ...
            return {"project_id": project.id, "episodes": episodes}
