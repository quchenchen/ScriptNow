...
from scriptflow_v7.novel.continuity import latest_effective_revisions
...
from scriptflow_v7.platform.models import ProjectModel, RunStatus, TenantModel
from scriptflow_v7.platform.run_coordinator import RunCoordinator
from scriptflow_v7.platform.run_events import PersistentRunEventLog, RunEventType
        ...
        *,
        ...
        async def stream_candidate(event: AgentEvent) -> None:
            ...
            if isinstance(event, ThinkingBlockDeltaEvent):
                ...
                event_type = RunEventType.NODE
            elif isinstance(event, CustomEvent) and event.name == "scriptflow.phase":
                payload = {
                    "block": "system",
