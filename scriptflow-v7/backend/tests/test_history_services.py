...
from scriptflow_v7.novel.history import NovelHistoryConflict, NovelHistoryService
...
from scriptflow_v7.script.history import ScriptHistoryConflict, ScriptHistoryService
