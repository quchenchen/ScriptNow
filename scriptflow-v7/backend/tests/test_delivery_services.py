...
from scriptflow_v7.novel.domain import NovelDocumentRevisionModel, NovelRevisionStatus
from scriptflow_v7.novel.project import NovelStoryMapModel, initialize_novel_project
...
from scriptflow_v7.script.domain import RevisionStatus, ScriptDocumentRevisionModel
from scriptflow_v7.script.export import render_script_docx
from scriptflow_v7.script.project import ScriptStoryMapModel, initialize_script_project
...
async def delivery_data():
    ...
    async with database.session() as session:
        ...
        script = ProjectModel(
            ...
            direction={"script_format": "chinese"},
        )
        novel = ProjectModel(
            tenant_id=tenant.id,
            name="小说项目",
