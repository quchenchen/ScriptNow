  ...
  <div class="shell">
    ...
    <div class="view">
      ...
      <div class="main-row">
        ...
        <!-- Asset Panel -->
        <aside class="right-panel" v-show="assetOpen">
        ...
        <!-- Chat Panel -->
        <aside class="right-panel" v-show="chatOpen">
