...
from scriptnow.platform.backup import BackupError, BackupService
...
def test_backup_restore_preserves_database_workspace_hash_events_and_balance(tmp_path) -> None:
    ...
    restored_database = tmp_path / "restored" / "scriptnow.sqlite3"
    ...
    assert manifest["format"] == "scriptnow-backup"
