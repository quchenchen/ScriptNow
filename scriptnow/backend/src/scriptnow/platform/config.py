...
class Settings(BaseSettings):
    ...
    # Default budget for style packs keeps SkillPlan behavior stable and predictable
    # across roles while still allowing explicit override via environment/config.
    skill_plan_optional_limit: int = Field(default=2, ge=0, le=20)
