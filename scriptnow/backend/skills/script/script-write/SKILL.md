...
| **触觉嗅觉** | 温温的、发麻、冰凉、刺痛、柔软、粗糙、闻到、气味、香味 | 摄影机和录音机拍不到触觉和嗅觉 |

---

## 四、「戏」——场景必须有事件

描述氛围和状态只是白描。白描不是戏。戏 = 事件 + 冲突 + 转折 + 后果。

### 什么是事件？

事件是「有人做了某事，改变了局面」，不是「有人在某个地方有某种感受」。
...
✅ 有事件：「她把一叠订单塞进继母手里。继母翻了两页——脸色变了。
   她站着没走，等继母把每一页都看完。」
   → 有人做了动作，局面发生了变化，有等待中的张力。
```

### 每场必须具备

1. **冲突**：至少一方有目标，且遭遇具体抵抗（不是「命运」，不是抽象困境）
2. **升级**：冲突在场景过程中加码——不是原地踏步。可以是新信息、新威胁、新选择
3. **转折**：场景结束时，权力/关系/信息/风险至少一项与开场时不同
4. **后果**：转折不是空转——它必须为下一场戏种下新的压力或选择

### 检验标准

读完一场戏，问自己：「这场戏发生了什么事？」如果答案是「一个人在某个地方，氛围怎样怎样」——这不是戏。如果答案是「A 做了 X，导致 B 失去了 Y」——这才是戏。
